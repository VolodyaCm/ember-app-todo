...
define('todo-app/tests/integration/components/export-data-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | export-data', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "kA27xQZP",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"export-data\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "K1HpUIh3",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"export-data\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/components/group-list-item-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | group-list-item', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "uqUsfSWz",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"group-list-item\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "mdYA5rBN",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"group-list-item\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/components/import-data-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | import-data', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "B1LUrezS",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"import-data\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "B3kfH1Ee",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"import-data\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/components/main-group-list-item-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | main-group-list-item', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "BoGX9YNh",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"main-group-list-item\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "8dIIwsTl",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"main-group-list-item\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/components/subgroup-list-item-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | subgroup-list-item', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "JV8E1ds/",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"subgroup-list-item\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "+WdaAPTs",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"subgroup-list-item\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/components/task-list-item-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';
  ...
  (0, _qunit.module)('Integration | Component | task-list-item', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "s/hcbkkb",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"task-list-item\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "OLWz59li",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"task-list-item\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/helpers/array-items-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | array-items', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "YCTgXU1M",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"array-items\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/helpers/check-modal-type-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | check-modal-type', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "9jzYPJIG",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"check-modal-type\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/helpers/compire-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | compire', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "8XDRK5nG",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"compire\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/integration/helpers/subtract-unit-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | subtract-unit', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "vXL/B5lA",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"subtract-unit\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('todo-app/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('adapters/group.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'adapters/group.js should pass ESLint\n\n');
  });

  QUnit.test('adapters/subgroup.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'adapters/subgroup.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('components/export-data.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/export-data.js should pass ESLint\n\n3:10 - \'computed\' is defined but never used. (no-unused-vars)\n11:18 - \'XLSX\' is not defined. (no-undef)\n19:18 - \'XLSX\' is not defined. (no-undef)\n21:21 - \'XLSX\' is not defined. (no-undef)\n30:10 - Unnecessary semicolon. (no-extra-semi)');
  });

  QUnit.test('components/group-list-item.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/group-list-item.js should pass ESLint\n\n7:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)');
  });

  QUnit.test('components/import-data.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/import-data.js should pass ESLint\n\n20:4 - Unnecessary semicolon. (no-extra-semi)\n24:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)\n29:13 - Use import { alias } from \'@ember/object/computed\'; instead of using Ember.computed.alias (ember/new-module-imports)\n30:3 - Only string, number, symbol, boolean, null, undefined, and function are allowed as default properties (ember/avoid-leaking-state-in-ember-objects)\n38:22 - \'XLSX\' is not defined. (no-undef)\n82:14 - \'XLSX\' is not defined. (no-undef)\n87:14 - \'XLSX\' is not defined. (no-undef)');
  });

  QUnit.test('components/main-group-list-item.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/main-group-list-item.js should pass ESLint\n\n7:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)');
  });

  QUnit.test('components/subgroup-list-item.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/subgroup-list-item.js should pass ESLint\n\n6:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)\n6:10 - \'Ember\' is not defined. (no-undef)');
  });

  QUnit.test('components/task-list-item.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/task-list-item.js should pass ESLint\n\n6:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)\n8:13 - Use import { alias } from \'@ember/object/computed\'; instead of using Ember.computed.alias (ember/new-module-imports)\n10:11 - Use import { alias } from \'@ember/object/computed\'; instead of using Ember.computed.alias (ember/new-module-imports)');
  });

  QUnit.test('controllers/todo.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/todo.js should pass ESLint\n\n33:13 - Use import { alias } from \'@ember/object/computed\'; instead of using Ember.computed.alias (ember/new-module-imports)\n35:3 - Only string, number, symbol, boolean, null, undefined, and function are allowed as default properties (ember/avoid-leaking-state-in-ember-objects)\n116:15 - \'storeItems\' is assigned a value but never used. (no-unused-vars)\n158:7 - Unexpected console statement. (no-console)\n159:7 - Unexpected console statement. (no-console)');
  });

  QUnit.test('helpers/array-items.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/array-items.js should pass ESLint\n\n');
  });

  QUnit.test('helpers/check-modal-type.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/check-modal-type.js should pass ESLint\n\n');
  });

  QUnit.test('helpers/compire.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/compire.js should pass ESLint\n\n');
  });

  QUnit.test('helpers/subtract-unit.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/subtract-unit.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('models/subgroup.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/subgroup.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('services/group.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/group.js should pass ESLint\n\n2:8 - \'Ember\' is defined but never used. (no-unused-vars)');
  });

  QUnit.test('services/item.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/item.js should pass ESLint\n\n5:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)');
  });

  QUnit.test('services/location-data.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/location-data.js should pass ESLint\n\n3:23 - \'computed\' is defined but never used. (no-unused-vars)\n7:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)');
  });

  QUnit.test('services/store-items.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/store-items.js should pass ESLint\n\n6:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)');
  });

  QUnit.test('services/subgroup.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'services/subgroup.js should pass ESLint\n\n');
  });

  QUnit.test('services/task-state.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/task-state.js should pass ESLint\n\n7:10 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)\n7:10 - \'Ember\' is not defined. (no-undef)\n10:13 - Use import { alias } from \'@ember/object/computed\'; instead of using Ember.computed.alias (ember/new-module-imports)\n10:13 - \'Ember\' is not defined. (no-undef)');
  });

  QUnit.test('services/task.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'services/task.js should pass ESLint\n\n');
  });

  QUnit.test('storages/stats.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'storages/stats.js should pass ESLint\n\n');
  });
});
define('todo-app/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('todo-app/templates/components/export-data.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'todo-app/templates/components/export-data.hbs should pass TemplateLint.\n\ntodo-app/templates/components/export-data.hbs\n  25:11  error  Incorrect indentation of htmlAttribute \'type\' beginning at L25:C11. Expected \'type\' to be at L26:C6.  attribute-indentation\n  25:25  error  Incorrect indentation of htmlAttribute \'class\' beginning at L25:C25. Expected \'class\' to be at L27:C6.  attribute-indentation\n  25:49  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L25:C49. Expected \'onclick\' to be at L28:C6.  attribute-indentation\n  25:130  error  Incorrect indentation of htmlAttribute \'value\' beginning at L25:C130. Expected \'value\' to be at L26:C6.  attribute-indentation\n  25:150  error  Incorrect indentation of close bracket \'>\' for the element \'<input>\' beginning at L25:C150. Expected \'<input>\' to be at L27:C4.  attribute-indentation\n  26:11  error  Incorrect indentation of htmlAttribute \'class\' beginning at L26:C11. Expected \'class\' to be at L27:C6.  attribute-indentation\n  26:35  error  Incorrect indentation of htmlAttribute \'value\' beginning at L26:C35. Expected \'value\' to be at L28:C6.  attribute-indentation\n  26:57  error  Incorrect indentation of htmlAttribute \'type\' beginning at L26:C57. Expected \'type\' to be at L29:C6.  attribute-indentation\n  26:71  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L26:C71. Expected \'onclick\' to be at L30:C6.  attribute-indentation\n  26:152  error  Incorrect indentation of close bracket \'>\' for the element \'<input>\' beginning at L26:C152. Expected \'<input>\' to be at L27:C4.  attribute-indentation\n  20:10  error  elements cannot have inline styles  no-inline-styles\n  26:4  error  Self-closing a void element is redundant  self-closing-void-elements\n');
  });

  QUnit.test('todo-app/templates/components/group-list-item.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'todo-app/templates/components/group-list-item.hbs should pass TemplateLint.\n\ntodo-app/templates/components/group-list-item.hbs\n  2:5  error  Incorrect indentation of htmlAttribute \'href\' beginning at L2:C5. Expected \'href\' to be at L3:C4.  attribute-indentation\n  2:14  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L2:C14. Expected \'onclick\' to be at L4:C4.  attribute-indentation\n  2:57  error  Incorrect indentation of htmlAttribute \'class\' beginning at L2:C57. Expected \'class\' to be at L3:C4.  attribute-indentation\n  2:95  error  Incorrect indentation of htmlAttribute \'title\' beginning at L2:C95. Expected \'title\' to be at L4:C4.  attribute-indentation\n  2:115  error  Incorrect indentation of close bracket \'>\' for the element \'<a>\' beginning at L2:C115. Expected \'<a>\' to be at L3:C2.  attribute-indentation\n  6:11  error  Incorrect indentation of htmlAttribute \'class\' beginning at L6:C11. Expected \'class\' to be at L7:C8.  attribute-indentation\n  6:68  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L6:C68. Expected \'onclick\' to be at L8:C8.  attribute-indentation\n  6:109  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L6:C109. Expected \'<div>\' to be at L7:C6.  attribute-indentation\n  6:68  error  Interaction added to non-interactive element  no-invalid-interactive\n  2:63  error  Unnecessary string concatenation. Use {{if group.state "active-g"}} instead of "{{if group.state "active-g"}}".  no-unnecessary-concat\n');
  });

  QUnit.test('todo-app/templates/components/import-data.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'todo-app/templates/components/import-data.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('todo-app/templates/components/main-group-list-item.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'todo-app/templates/components/main-group-list-item.hbs should pass TemplateLint.\n\ntodo-app/templates/components/main-group-list-item.hbs\n  2:5  error  Incorrect indentation of htmlAttribute \'href\' beginning at L2:C5. Expected \'href\' to be at L3:C4.  attribute-indentation\n  2:14  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L2:C14. Expected \'onclick\' to be at L4:C4.  attribute-indentation\n  2:57  error  Incorrect indentation of htmlAttribute \'class\' beginning at L2:C57. Expected \'class\' to be at L3:C4.  attribute-indentation\n  2:95  error  Incorrect indentation of htmlAttribute \'title\' beginning at L2:C95. Expected \'title\' to be at L4:C4.  attribute-indentation\n  2:115  error  Incorrect indentation of close bracket \'>\' for the element \'<a>\' beginning at L2:C115. Expected \'<a>\' to be at L3:C2.  attribute-indentation\n  2:63  error  Unnecessary string concatenation. Use {{if group.state "active-g"}} instead of "{{if group.state "active-g"}}".  no-unnecessary-concat\n');
  });

  QUnit.test('todo-app/templates/components/subgroup-list-item.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'todo-app/templates/components/subgroup-list-item.hbs should pass TemplateLint.\n\ntodo-app/templates/components/subgroup-list-item.hbs\n  1:5  error  Incorrect indentation of htmlAttribute \'class\' beginning at L1:C5. Expected \'class\' to be at L2:C2.  attribute-indentation\n  1:61  error  Incorrect indentation of htmlAttribute \'id\' beginning at L1:C61. Expected \'id\' to be at L3:C2.  attribute-indentation\n  1:82  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L1:C82. Expected \'onclick\' to be at L4:C2.  attribute-indentation\n  1:136  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L1:C136. Expected \'<div>\' to be at L2:C0.  attribute-indentation\n  13:17  error  Incorrect indentation of htmlAttribute \'class\' beginning at L13:C17. Expected \'class\' to be at L14:C14.  attribute-indentation\n  13:49  error  Incorrect indentation of htmlAttribute \'role\' beginning at L13:C49. Expected \'role\' to be at L15:C14.  attribute-indentation\n  13:68  error  Incorrect indentation of htmlAttribute \'style\' beginning at L13:C68. Expected \'style\' to be at L16:C14.  attribute-indentation\n  13:87  error  Incorrect indentation of htmlAttribute \'aria-valuenow\' beginning at L13:C87. Expected \'aria-valuenow\' to be at L17:C14.  attribute-indentation\n  13:106  error  Incorrect indentation of htmlAttribute \'aria-valuemin\' beginning at L13:C106. Expected \'aria-valuemin\' to be at L18:C14.  attribute-indentation\n  13:124  error  Incorrect indentation of htmlAttribute \'aria-valuemax\' beginning at L13:C124. Expected \'aria-valuemax\' to be at L19:C14.  attribute-indentation\n  13:143  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L13:C143. Expected \'<div>\' to be at L20:C12.  attribute-indentation\n  13:68  error  elements cannot have inline styles  no-inline-styles\n  1:82  error  Interaction added to non-interactive element  no-invalid-interactive\n  1:64  error  Unnecessary string concatenation. Use {{subgroup.id}} instead of "{{subgroup.id}}".  no-unnecessary-concat\n  1:46  error  you must use double quotes in templates  quotes\n');
  });

  QUnit.test('todo-app/templates/components/task-list-item.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'todo-app/templates/components/task-list-item.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('todo-app/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'todo-app/templates/index.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('todo-app/templates/todo.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'todo-app/templates/todo.hbs should pass TemplateLint.\n\ntodo-app/templates/todo.hbs\n  10:15  error  Incorrect indentation of htmlAttribute \'class\' beginning at L10:C15. Expected \'class\' to be at L11:C12.  attribute-indentation\n  10:91  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L10:C91. Expected \'<div>\' to be at L12:C10.  attribute-indentation\n  50:18  error  Incorrect indentation of attribute \'value\' beginning at L50:C18. Expected \'value\' to be at L51:C12.  attribute-indentation\n  50:30  error  Incorrect indentation of attribute \'class\' beginning at L50:C30. Expected \'class\' to be at L52:C12.  attribute-indentation\n  50:90  error  Incorrect indentation of attribute \'aria-label\' beginning at L50:C90. Expected \'aria-label\' to be at L53:C12.  attribute-indentation\n  50:124  error  Incorrect indentation of attribute \'aria-describedby\' beginning at L50:C124. Expected \'aria-describedby\' to be at L54:C12.  attribute-indentation\n  50:156  error  Incorrect indentation of attribute \'placeholder\' beginning at L50:C156. Expected \'placeholder\' to be at L55:C12.  attribute-indentation\n  50:182  error  Incorrect indentation of attribute \'keyDown\' beginning at L50:C182. Expected \'keyDown\' to be at L56:C12.  attribute-indentation\n  50:209  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{input}}\' beginning at L50:C209. Expected \'{{input}}\' to be at L57:C10.  attribute-indentation\n  85:7  error  Incorrect indentation of htmlAttribute \'id\' beginning at L85:C7. Expected \'id\' to be at L86:C4.  attribute-indentation\n  85:20  error  Incorrect indentation of htmlAttribute \'class\' beginning at L85:C20. Expected \'class\' to be at L87:C4.  attribute-indentation\n  85:89  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L85:C89. Expected \'<div>\' to be at L88:C2.  attribute-indentation\n  88:16  error  Incorrect indentation of htmlAttribute \'type\' beginning at L88:C16. Expected \'type\' to be at L89:C10.  attribute-indentation\n  88:30  error  Incorrect indentation of htmlAttribute \'id\' beginning at L88:C30. Expected \'id\' to be at L90:C10.  attribute-indentation\n  88:51  error  Incorrect indentation of htmlAttribute \'class\' beginning at L88:C51. Expected \'class\' to be at L91:C10.  attribute-indentation\n  88:72  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L88:C72. Expected \'onclick\' to be at L92:C10.  attribute-indentation\n  88:103  error  Incorrect indentation of close bracket \'>\' for the element \'<button>\' beginning at L88:C103. Expected \'<button>\' to be at L89:C8.  attribute-indentation\n  92:16  error  Incorrect indentation of htmlAttribute \'class\' beginning at L92:C16. Expected \'class\' to be at L93:C10.  attribute-indentation\n  92:70  error  Incorrect indentation of htmlAttribute \'type\' beginning at L92:C70. Expected \'type\' to be at L94:C10.  attribute-indentation\n  92:84  error  Incorrect indentation of htmlAttribute \'data-toggle\' beginning at L92:C84. Expected \'data-toggle\' to be at L95:C10.  attribute-indentation\n  92:107  error  Incorrect indentation of htmlAttribute \'data-target\' beginning at L92:C107. Expected \'data-target\' to be at L96:C10.  attribute-indentation\n  92:145  error  Incorrect indentation of htmlAttribute \'aria-controls\' beginning at L92:C145. Expected \'aria-controls\' to be at L97:C10.  attribute-indentation\n  92:184  error  Incorrect indentation of htmlAttribute \'aria-expanded\' beginning at L92:C184. Expected \'aria-expanded\' to be at L98:C10.  attribute-indentation\n  92:206  error  Incorrect indentation of htmlAttribute \'aria-label\' beginning at L92:C206. Expected \'aria-label\' to be at L99:C10.  attribute-indentation\n  92:245  error  Incorrect indentation of close bracket \'>\' for the element \'<button>\' beginning at L92:C245. Expected \'<button>\' to be at L100:C8.  attribute-indentation\n  125:15  error  Incorrect indentation of htmlAttribute \'class\' beginning at L125:C15. Expected \'class\' to be at L126:C12.  attribute-indentation\n  125:91  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L125:C91. Expected \'<div>\' to be at L127:C10.  attribute-indentation\n  169:23  error  Incorrect indentation of htmlAttribute \'class\' beginning at L169:C23. Expected \'class\' to be at L170:C20.  attribute-indentation\n  169:38  error  Incorrect indentation of htmlAttribute \'class\' beginning at L169:C38. Expected \'class\' to be at L171:C20.  attribute-indentation\n  169:61  error  Incorrect indentation of htmlAttribute \'onclick\' beginning at L169:C61. Expected \'onclick\' to be at L172:C20.  attribute-indentation\n  169:118  error  Incorrect indentation of close bracket \'>\' for the element \'<div>\' beginning at L169:C118. Expected \'<div>\' to be at L170:C18.  attribute-indentation\n  183:20  error  Incorrect indentation of attribute \'value\' beginning at L183:C20. Expected \'value\' to be at L184:C14.  attribute-indentation\n  183:35  error  Incorrect indentation of attribute \'class\' beginning at L183:C35. Expected \'class\' to be at L185:C14.  attribute-indentation\n  183:75  error  Incorrect indentation of attribute \'aria-label\' beginning at L183:C75. Expected \'aria-label\' to be at L186:C14.  attribute-indentation\n  183:109  error  Incorrect indentation of attribute \'aria-describedby\' beginning at L183:C109. Expected \'aria-describedby\' to be at L187:C14.  attribute-indentation\n  183:141  error  Incorrect indentation of attribute \'placeholder\' beginning at L183:C141. Expected \'placeholder\' to be at L188:C14.  attribute-indentation\n  183:170  error  Incorrect indentation of attribute \'keyDown\' beginning at L183:C170. Expected \'keyDown\' to be at L189:C14.  attribute-indentation\n  183:200  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{input}}\' beginning at L183:C200. Expected \'{{input}}\' to be at L190:C12.  attribute-indentation\n  189:22  error  Incorrect indentation of attribute \'value\' beginning at L189:C22. Expected \'value\' to be at L190:C16.  attribute-indentation\n  189:33  error  Incorrect indentation of attribute \'class\' beginning at L189:C33. Expected \'class\' to be at L191:C16.  attribute-indentation\n  189:73  error  Incorrect indentation of attribute \'aria-label\' beginning at L189:C73. Expected \'aria-label\' to be at L192:C16.  attribute-indentation\n  189:107  error  Incorrect indentation of attribute \'aria-describedby\' beginning at L189:C107. Expected \'aria-describedby\' to be at L193:C16.  attribute-indentation\n  189:139  error  Incorrect indentation of attribute \'placeholder\' beginning at L189:C139. Expected \'placeholder\' to be at L194:C16.  attribute-indentation\n  189:164  error  Incorrect indentation of attribute \'keyDown\' beginning at L189:C164. Expected \'keyDown\' to be at L195:C16.  attribute-indentation\n  189:212  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{input}}\' beginning at L189:C212. Expected \'{{input}}\' to be at L196:C14.  attribute-indentation\n  27:4  error  Incorrect indentation for `<ul>` beginning at L27:C4. Expected `<ul>` to be at an indentation of 6 but was found at 4.  block-indentation\n  169:38  error  Duplicate attribute \'class\' found in the Element.  no-duplicate-attributes\n  62:10  error  Interaction added to non-interactive element  no-invalid-interactive\n  79:10  error  Interaction added to non-interactive element  no-invalid-interactive\n  169:61  error  Interaction added to non-interactive element  no-invalid-interactive\n  2:26  error  Unnecessary string concatenation. Use {{if menu "active"}} instead of "{{if menu "active"}}".  no-unnecessary-concat\n');
  });
});
define('todo-app/tests/lint/tests.lint-test', [], function () {
  ...
  QUnit.test('integration/components/group-list-item-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/group-list-item-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/import-data-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/import-data-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/main-group-list-item-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/main-group-list-item-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/subgroup-list-item-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/subgroup-list-item-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/task-list-item-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/task-list-item-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/helpers/array-items-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/helpers/array-items-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/helpers/check-modal-type-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/helpers/check-modal-type-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/helpers/compire-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/helpers/compire-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/helpers/subtract-unit-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/helpers/subtract-unit-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/services/group-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/group-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/item-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/item-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/location-data-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/location-data-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/store-items-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/store-items-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/subgroup-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/subgroup-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/task-state-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/task-state-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/task-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/task-test.js should pass ESLint\n\n');
  });
});
...
define('todo-app/tests/unit/routes/index-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('todo-app/tests/unit/routes/todo-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('todo-app/tests/unit/services/group-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | Group', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let service = this.owner.lookup('service:group');
      assert.ok(service);
    });
  });
});
define('todo-app/tests/unit/services/item-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | item', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let service = this.owner.lookup('service:item');
      assert.ok(service);
    });
  });
});
define('todo-app/tests/unit/services/location-data-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | location-data', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let service = this.owner.lookup('service:location-data');
      assert.ok(service);
    });
  });
});
define('todo-app/tests/unit/services/store-items-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | store-items', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('todo-app/tests/unit/services/subgroup-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | subgroup', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let service = this.owner.lookup('service:subgroup');
      assert.ok(service);
    });
  });
});
define('todo-app/tests/unit/services/task-state-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | task-state', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('todo-app/tests/unit/services/task-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | task', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
